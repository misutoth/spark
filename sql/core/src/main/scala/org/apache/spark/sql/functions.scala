...
// scalastyle:on
  ...
  /**
   * @param colName the value whose arc sine is to be returned
   * @return        sine inverse of the given value in the range of 0.0 through pi,
   *                as if computed by [[java.lang.Math#asin]]
   *
   * @group math_funcs
  ...
  /**
   * @param colName the value whose arc tangent is to be returned
   * @return        tangent inverse of the given value in the range of -pi/2 through pi/2,
   *                as if computed by [[java.lang.Math#atan]]
   *
   * @group math_funcs
  ...
  /**
   * @param colName angle in radians
   * @return        cosine of the angle, as if computed by [[java.lang.Math#cos]]
   *
   * @group math_funcs
   * @since 1.4.0
  ...
  /**
   * @param colName number whose hyperbolic sine is to be returned
   * @return        hyperbolic sine of the given value, as if computed by [[java.lang.Math#sinh]]
   *
   * @group math_funcs
   * @since 1.4.0
  ...
  /**
   * @param  colName number whose hyperbolic tangent is to be returned
   ...
   * Converts an angle measured in degrees to an approximately equivalent angle measured in radians.
   *
   * @param  colName angle in degrees
   * @return         angle in radians, as if computed by [[java.lang.Math#toRadians]]
   *
   * @group math_funcs
   * @since 2.1.0
